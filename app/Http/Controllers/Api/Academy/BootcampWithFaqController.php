...
use App\Http\Requests\Academy\BootcampWithFaqStoreRequest;
use App\Http\Requests\Academy\BootcampWithFaqUpdateRequest;
        ...
        try {
            return DB::transaction(function () use ($request) {
                ...
                if (!empty($categoryIds)) {
                    ...
                    $bootcamp->categories()->attach($resolvedCategoryIds);
                }
