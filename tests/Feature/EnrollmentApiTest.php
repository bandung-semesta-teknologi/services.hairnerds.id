...
describe('enrollment crud api', function () {
    ...
    describe('filtering and searching', function () {
        ...
        it('can filter enrollments by user_id', function () {
            Enrollment::factory()->count(3)->create([
                'user_id' => $this->student->id,
                'course_id' => $this->publishedCourse->id
            ]);
        ...
        it('can filter enrollments by course_id', function () {
            Enrollment::factory()->count(3)->create([
                'user_id' => $this->student->id,
                'course_id' => $this->publishedCourse->id
            ]);
            ...
            getJson("/api/enrollments?course_id={$this->publishedCourse->id}")
                ->assertOk()
                ->assertJsonCount(4, 'data');
        });

        it('can filter enrollments by status finished', function () {
            Enrollment::factory()->count(2)->finished()->create([
                'user_id' => $this->student->id,
                'course_id' => $this->publishedCourse->id
            ]);
        ...
        it('can filter enrollments by status active', function () {
            Enrollment::factory()->count(2)->finished()->create([
                'user_id' => $this->student->id,
                'course_id' => $this->publishedCourse->id
            ]);
        ...
        it('can paginate enrollments', function () {
