...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::table('membership_transactions', function (Blueprint $table) {
            ...
            $table->string('merchant_user_id')->after('merchant_id');
            $table->string('merchant_name')->after('merchant_user_id');
    ...
    public function down(): void
    {
        Schema::table('membership_transactions', function (Blueprint $table) {
            ...
            $table->dropColumn(['merchant_id', 'merchant_user_id', 'user_id', 'user_uuid_supabase', 'serial_number', 'card_number', 'merchant_name', 'merchant_email']);
        });
    }
};
